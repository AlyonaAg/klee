; ModuleID = '/home/klee/examples/samples/big_array.bc'
source_filename = "big_array.c"
...
@.str.23 = private unnamed_addr constant [7 x i8] c"dynTlv\00", align 1
@.str.24 = private unnamed_addr constant [10 x i8] c"outLen[0]\00", align 1
...
entry:
  ...
  store i32 4096, i32* %buffLen, align 4
  %1 = bitcast [6 x %struct.QosDynTlv]* %dynTlv to i8*
  call void @klee_make_symbolic(i8* %1, i64 72, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.23, i64 0, i64 0))
  ...
  store i32 6, i32* %tlvNum, align 4
  %call = call i8* @malloc(i64 4)
  %2 = bitcast i8* %call to i32*
  store i32* %2, i32** %outLen, align 8
  %3 = load i32*, i32** %outLen, align 8
  %4 = bitcast i32* %3 to i8*
  call void @klee_make_symbolic(i8* %4, i64 4, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.24, i64 0, i64 0))
  %arraydecay = getelementptr inbounds [4096 x i8], [4096 x i8]* %buff, i64 0, i64 0
  %5 = load i32, i32* %buffLen, align 4
  %arraydecay11 = getelementptr inbounds [6 x %struct.QosDynTlv], [6 x %struct.QosDynTlv]* %dynTlv, i64 0, i64 0
  %6 = load i32, i32* %tlvNum, align 4
  %7 = load i32*, i32** %outLen, align 8
  %call12 = call i32 @QOS_JoinTlvs(i8* %arraydecay, i32 %5, %struct.QosDynTlv* %arraydecay11, i32 %6, i32* %7)
  store i32 %call12, i32* %res, align 4
  %8 = bitcast i32* %RET to i8*
  call void @klee_make_symbolic(i8* %8, i64 4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.25, i64 0, i64 0))
