; ModuleID = '/home/klee/examples/samples/loop_1.bc'
...
%struct.tagVmeSmpMsgInfo = type <{ i8*, i16, i16, i8*, i32*, i32*, i8*, i32, i16, i16, i32*, i32*, i32, i32 }>
...
entry:
  ...
  %3 = load i32*, i32** %pCurBlock, align 1
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %6 = load i8, i8* %ucCondNum, align 1
  %conv1 = zext i8 %6 to i32
  %cmp = icmp ult i32 %5, %conv1
...
for.body:                                         ; preds = %for.cond
  ...
  store i8* %8, i8** %pFieldValue, align 8
  %9 = load %struct.CLASS_AIS_AIECNSTATEDYN_S*, %struct.CLASS_AIS_AIECNSTATEDYN_S** %aiEcnState, align 8
  %queueId = getelementptr inbounds %struct.CLASS_AIS_AIECNSTATEDYN_S, %struct.CLASS_AIS_AIECNSTATEDYN_S* %9, i32 0, i32 0
  %10 = load i8, i8* %queueId, align 4
  %conv3 = zext i8 %10 to i32
  %cmp4 = icmp eq i32 %conv3, 0
  %11 = load %struct.tagTlvAppCfgiTblFldCondItem*, %struct.tagTlvAppCfgiTblFldCondItem** %pstTblFldCondItem.addr, align 8
  %cmp6 = icmp eq %struct.tagTlvAppCfgiTblFldCondItem* %11, null
...
if.end:                                           ; preds = %for.body
  %12 = load %struct.tagTlvAppCfgiTblFldCondItem*, %struct.tagTlvAppCfgiTblFldCondItem** %pstTblFldCondItem.addr, align 8
  %ucFieldID = getelementptr inbounds %struct.tagTlvAppCfgiTblFldCondItem, %struct.tagTlvAppCfgiTblFldCondItem* %12, i32 0, i32 0
  %13 = load i8, i8* %ucFieldID, align 2
...
sw.bb:                                            ; preds = %if.end
  %14 = load i8*, i8** %pFieldValue, align 8
  %15 = bitcast i8* %14 to i32*
  %16 = load i32, i32* %15, align 4
  %17 = load %struct.CLASS_AIS_AIECNSTATEDYN_S*, %struct.CLASS_AIS_AIECNSTATEDYN_S** %aiEcnState, align 8
  %ifIndex = getelementptr inbounds %struct.CLASS_AIS_AIECNSTATEDYN_S, %struct.CLASS_AIS_AIECNSTATEDYN_S* %17, i32 0, i32 10
  store i32 %16, i32* %ifIndex, align 4
  br label %for.inc

sw.bb9:                                           ; preds = %if.end
  %18 = load i8*, i8** %pFieldValue, align 8
  %19 = load i8, i8* %18, align 1
  %20 = load %struct.CLASS_AIS_AIECNSTATEDYN_S*, %struct.CLASS_AIS_AIECNSTATEDYN_S** %aiEcnState, align 8
  %queueId10 = getelementptr inbounds %struct.CLASS_AIS_AIECNSTATEDYN_S, %struct.CLASS_AIS_AIECNSTATEDYN_S* %20, i32 0, i32 0
  store i8 %19, i8* %queueId10, align 4
  br label %for.inc
...
entry:
  ...
  call void @klee_make_symbolic(i8* %1, i64 76, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.1, i64 0, i64 0))
