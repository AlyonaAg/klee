; ModuleID = '/home/klee/examples/samples/loop_3.bc'
...
%struct.Fsm = type { %struct.AisDynEcnV2FsmActTable*, i32, i32, i32, i32, i32, i32 }
...
entry:
  ...
  %2 = load %struct.AisDynEcnV2FsmActTable*, %struct.AisDynEcnV2FsmActTable** %actTable1, align 8
  store %struct.AisDynEcnV2FsmActTable* %2, %struct.AisDynEcnV2FsmActTable** %actTable, align 8
  store void (i8*, i32*)* null, void (i8*, i32*)** %eventActFun, align 8
  %3 = load %struct.Fsm*, %struct.Fsm** %pFsm, align 8
  %curStates = getelementptr inbounds %struct.Fsm, %struct.Fsm* %3, i32 0, i32 1
  %4 = load i32, i32* %curStates, align 8
  store i32 %4, i32* %curState, align 4
  store i32 0, i32* %nextState, align 4
  %5 = load %struct.AisDynEcnV2Data*, %struct.AisDynEcnV2Data** %stateParam.addr, align 8
  call void @AIS_SyncFSMECN(%struct.AisDynEcnV2Data* %5)
...
for.cond:                                         ; preds = %for.inc, %entry
  ...
  %7 = load %struct.Fsm*, %struct.Fsm** %pFsm, align 8
  %size = getelementptr inbounds %struct.Fsm, %struct.Fsm* %7, i32 0, i32 4
  %8 = load i32, i32* %size, align 4
  %cmp = icmp slt i32 %6, %8
  br i1 %cmp, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %9 = load %struct.Fsm*, %struct.Fsm** %pFsm, align 8
  %event = getelementptr inbounds %struct.Fsm, %struct.Fsm* %9, i32 0, i32 3
  %10 = load i32, i32* %event, align 8
  %11 = load %struct.AisDynEcnV2FsmActTable*, %struct.AisDynEcnV2FsmActTable** %actTable, align 8
  %12 = load i32, i32* %i, align 4
  %idxprom = sext i32 %12 to i64
  %arrayidx = getelementptr inbounds %struct.AisDynEcnV2FsmActTable, %struct.AisDynEcnV2FsmActTable* %11, i64 %idxprom
  %event2 = getelementptr inbounds %struct.AisDynEcnV2FsmActTable, %struct.AisDynEcnV2FsmActTable* %arrayidx, i32 0, i32 1
  %13 = load i32, i32* %event2, align 4
  %cmp3 = icmp eq i32 %10, %13
  br i1 %cmp3, label %land.lhs.true, label %for.inc

land.lhs.true:                                    ; preds = %for.body
  %14 = load i32, i32* %curState, align 4
  %15 = load %struct.AisDynEcnV2FsmActTable*, %struct.AisDynEcnV2FsmActTable** %actTable, align 8
  %16 = load i32, i32* %i, align 4
  %idxprom4 = sext i32 %16 to i64
  %arrayidx5 = getelementptr inbounds %struct.AisDynEcnV2FsmActTable, %struct.AisDynEcnV2FsmActTable* %15, i64 %idxprom4
  %curState6 = getelementptr inbounds %struct.AisDynEcnV2FsmActTable, %struct.AisDynEcnV2FsmActTable* %arrayidx5, i32 0, i32 0
  %17 = load i32, i32* %curState6, align 8
  %cmp7 = icmp eq i32 %14, %17
  br i1 %cmp7, label %if.then, label %for.inc

if.then:                                          ; preds = %land.lhs.true
  store i32 1, i32* %flag, align 4
  %18 = load %struct.AisDynEcnV2FsmActTable*, %struct.AisDynEcnV2FsmActTable** %actTable, align 8
  %19 = load i32, i32* %i, align 4
  %idxprom8 = sext i32 %19 to i64
  %arrayidx9 = getelementptr inbounds %struct.AisDynEcnV2FsmActTable, %struct.AisDynEcnV2FsmActTable* %18, i64 %idxprom8
  %eventActFun10 = getelementptr inbounds %struct.AisDynEcnV2FsmActTable, %struct.AisDynEcnV2FsmActTable* %arrayidx9, i32 0, i32 2
  %20 = load void (i8*, i32*)*, void (i8*, i32*)** %eventActFun10, align 8
  store void (i8*, i32*)* %20, void (i8*, i32*)** %eventActFun, align 8
  %21 = load %struct.AisDynEcnV2FsmActTable*, %struct.AisDynEcnV2FsmActTable** %actTable, align 8
  %22 = load i32, i32* %i, align 4
  %idxprom11 = sext i32 %22 to i64
  %arrayidx12 = getelementptr inbounds %struct.AisDynEcnV2FsmActTable, %struct.AisDynEcnV2FsmActTable* %21, i64 %idxprom11
  %nextState13 = getelementptr inbounds %struct.AisDynEcnV2FsmActTable, %struct.AisDynEcnV2FsmActTable* %arrayidx12, i32 0, i32 3
  %23 = load i32, i32* %nextState13, align 8
  store i32 %23, i32* %nextState, align 4
  br label %for.end
...
if.end16:                                         ; preds = %for.end
  %26 = load %struct.AisDynEcnV2Data*, %struct.AisDynEcnV2Data** %stateParam.addr, align 8
  %call = call i32 @AIS_ECNOutput(%struct.AisDynEcnV2Data* %26)
...
entry:
  ...
  call void @klee_make_symbolic(i8* %0, i64 612, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str, i64 0, i64 0))
