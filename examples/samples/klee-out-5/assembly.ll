; ModuleID = '/home/klee/examples/samples/linked_list.bc'
...
@.str.28 = private unnamed_addr constant [5 x i8] c"$RET\00", align 1
...
entry:
  ...
  store i32 16, i32* %tlvNum, align 4
  %24 = load %struct.tagQOS_TLV_PROXY*, %struct.tagQOS_TLV_PROXY** %proxy, align 8
  %25 = load %struct.tagVrpTLVHead*, %struct.tagVrpTLVHead** %head, align 8
  %26 = bitcast %struct.tagVrpTLVHead* %25 to i8*
  %27 = load i32, i32* %tlvNum, align 4
  %call14 = call i32 @qos_walk_fim_tlv(%struct.tagQOS_TLV_PROXY* %24, i8* %26, i32 %27)
  store i32 %call14, i32* %res, align 4
  %28 = bitcast i32* %RET to i8*
  call void @klee_make_symbolic(i8* %28, i64 4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.28, i64 0, i64 0))
