...
entry:
  ...
  %n2 = alloca %union.str_n2, align 4
  store i32 0, i32* %retval, align 4
  %call = call noalias i8* @malloc(i64 4) #3
  %0 = bitcast i8* %call to i32*
  store i32* %0, i32** %n1, align 8
  %1 = bitcast %union.str_n2* %n2 to i8*
  call void @klee_make_symbolic(i8* %1, i64 4, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i64 0, i64 0))
  %2 = load i32*, i32** %n1, align 8
  store i32 15, i32* %2, align 4
  %3 = load i32*, i32** %n1, align 8
  %uiRet = bitcast %union.str_n2* %n2 to i32*
